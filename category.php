...
if (isset($_POST['fassion'])) {
    ...
    $sql = "SELECT * FROM item where Item_category = 'SUPER MARKET' ";
} elseif (isset($_POST['home'])) {
    $sql = "SELECT * FROM item where Item_category = 'HOME&OFFICE' ";
} elseif (isset($_POST['phones'])) {
    $sql = "SELECT * FROM item where Item_category = 'PHONE&ACCESSORIES' ";
}
    ...
    <div id="row">
        ...
        <div id="slide2">
            ...
            <div class="" style="max-width: 100%; height: 10px">
                <img class="mySlides1 w3-animate-top" src="font/online-shopping-banner-template_23-2148870419.jpg" style="width:100%; min-height: 340px">
                ...
                <img class=" mySlides1 w3-animate-top" src="font/soccer-jersey-template-sport-t-shirt-design_29096-1247.jpg" style="width:100%; min-height: 340px">
