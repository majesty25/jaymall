...
<body>
    ...
    <header>
        ...
        <div>
            <a href="jaymall.php"><img id="logo" src="font/Jaymall2.png" alt="" srcset=""></a>
        </div>
        ...
        <div id="user_panel" onmouseout="closeUser()" onmouseover="openUser()">
            ...
            <form method="post">
                <button id="user_list" name="login" type="submit"><i style="margin-right: 15px;" class='fas fa-sign-out-alt'></i> Log in</button>
                <?php
